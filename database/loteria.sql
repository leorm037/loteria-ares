...
-- -----------------------------------------------------
-- Table `loteria`.`loteria_premio_receber`
-- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `loteria`.`arquivo` (
  ...
  CONSTRAINT `fk_arquivo_usuario1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_arquivo_arquivo_tipo1`
...
CREATE TABLE IF NOT EXISTS `loteria`.`bolao_arquivo` (
  ...
  CONSTRAINT `fk_bolao_arquivo_arquivo1`
    FOREIGN KEY (`arquivo_id`)
    REFERENCES `loteria`.`arquivo` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_bolao_arquivo_bolao1`
    FOREIGN KEY (`bolao_id`)
    REFERENCES `loteria`.`bolao` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `loteria`.`apostador_arquivo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `loteria`.`apostador_arquivo` (
  ...
  CONSTRAINT `fk_bolao_apostador_arquivo1`
    FOREIGN KEY (`arquivo_id`)
    REFERENCES `loteria`.`arquivo` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_bolao_apostador_apostador1`
